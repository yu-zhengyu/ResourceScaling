...
public class AzureVMApiDemo {
    ...
    public static long seedmachine = 100000; 
    ...
    public static String createNewInstance(String[] command, String name) throws Exception {
        String seed = String.format("%d%d",
                (int) System.currentTimeMillis() % 1000,
                (int) (Math.random() * 1000));
        vmName = String.format("%s%s%s",name, seed, "vm");
        resourceGroupName = String.format("%s%s%s", name, seed, "ResourceGroup");
