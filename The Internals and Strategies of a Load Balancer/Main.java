...
public class Main {
	...
	static {
		...
		instances[0] = new DataCenterInstance("First", "http://datacenter-972522vm.eastus.cloudapp.azure.com");
		instances[1] = new DataCenterInstance("Second", "http://datacenter-497901vm.eastus.cloudapp.azure.com");
		instances[2] = new DataCenterInstance("Third", "http://datacenter-485510vm.eastus.cloudapp.azure.com");
	}
